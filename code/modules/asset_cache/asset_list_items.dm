...
/datum/asset/spritesheet/simple/paper
	...
	assets = list(
		...
		"stamp-warra" = 'icons/paper_graphics/stamps/large_stamp-warra_generic.png',
		"stamp-warra_cap" = 'icons/paper_graphics/stamps/large_stamp-warra_captain.png',
		"stamp-warra_fo" = 'icons/paper_graphics/stamps/large_stamp-warra_officer.png',
		"stamp-warra_engdir" = 'icons/paper_graphics/stamps/large_stamp-warra_eng_dir.png',
		"stamp-warra_meddir" = 'icons/paper_graphics/stamps/large_stamp-warra_med_dir.png',
		"stamp-warra_scidir" = 'icons/paper_graphics/stamps/large_stamp-warra_sci_dir.png',
		...
		"stamp-warra_central" = 'icons/paper_graphics/stamps/large_stamp-warra_central.png',
